...
pubDatetime: 2023-10-11T00:00:00.000Z
ogImage: ""
tags:
  - "CSS"
description: "tailwind 一直饱受非议, 其中说的最多的大概就是「我为什么不直接写内联样式?」. 其实 tailwind 不仅是简写了样式名这么简单, 它是一系列便利的封装.  动画 举个简单的例子, animate-spin 属性用于添加旋转动画, 常用在 loading 中. 如果你用传统的 cs..."
---
